  ...
  return (
      ...
      <footer className="footer p-10 bg-yellow-200 text-base-content sm:overflow-x-auto">
        <div>
          <Link to="/">
            ...
            <p className="text-black font-bold text-xl">VIRatIAN</p>
          </Link>
        ...
        <div>
          <span className="font-bold mb-2 text-xl text-black">Services</span>
        ...
        <div>
          <span className="font-bold mb-2 text-xl text-black"></span>
        ...
        <div>
          ...
          <div className="flex gap-2 items-center">
            ...
            <a className="">IIIt Nagpur</a>
          </div>
          <div className="flex gap-2 items-center">
            <FaPhoneAlt></FaPhoneAlt> <a className="">+91XXXXXXXX</a>
          </div>

          <div className="flex gap-2 items-center">
            <FaEnvelope></FaEnvelope> <a className="">viratian9767@gmail.com</a>
          </div>
        </div>
        <div>
    <span className="text-xl font-bold text-black">Magzine</span> 
    <div className="form-control w-80">
      ...
      <footer className="footer footer-center p-4 bg-yellow-300 text-base-content">
        <div>
          <p>Copyright © 2024- Viratian . All rights reserved.</p>
        </div>
      </footer>
    </>
  );
